...
EVENTS = {
    ...
    'BET_EXPIRATION': 'Bet %(tx_hash)s expired',
    ...
    'ASSET_CREATION': 'Asset %(asset)s created',
    'ASSET_ISSUANCE': 'Asset %(asset)s issued',
    'ORDER_EXPIRATION': 'Order %(tx_hash)s expired',
    ...
    'EHANCED_SEND': 'Ehanced send %(quantity)s %(asset)s from %(source)s to %(destination)s',
    'NPMA_SEND': 'NPMA send %(quantity)s %(asset)s from %(source)s to %(destination)s',
    ...
    'BET_MATCH_UPDATE': 'Updated bet match %(bet_match_id)s. New status: %(status)s',
    'ORDER_UPDATE': 'Updated order %(tx_hash)s. New status: %(status)s',
    'ORDER_FILLED': 'Order %(tx_hash)s filled',
    'ORDER_MATCH_UPDATE': 'Order match %(order_match_id)s updated. New status: %(status)s',
    'RPS_MATCH_UPDATE': 'Updated RPS match %(rps_match_id)s. New status: %(status)s',

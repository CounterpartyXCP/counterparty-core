...
BLOCK_FIRST_TESTNET_HASH = (
    "000000001f605ec6ee8d2c0d21bf3d3ded0a31ca837acc98893876213828989d"
)
...
BLOCK_FIRST_MAINNET_HASH = (
    "00000000000000017bac9a8e85660ad348050c789922d5f8fe544d473368be1a"
)
BURN_START_MAINNET = 278310
BURN_END_MAINNET = 283810

BLOCK_FIRST_REGTEST = 0
BLOCK_FIRST_REGTEST_HASH = (
...
DEFAULT_REGULAR_DUST_SIZE = (
    546  # TODO: Revisit when dust size is adjusted in bitcoin core
)
...
DEFAULT_FEE_PER_KB = (
    25000  # sane/low default, also used as minimum when estimated fee is used
)
...
ADDRESS_OPTION_MAX_VALUE = (
    ADDRESS_OPTION_REQUIRE_MEMO  # Or list of all the address options
)
OLD_STYLE_API = True
...
BOOTSTRAP_URL_TESTNET = (
    "https://bootstrap.counterparty.io/counterparty-testnet.latest.tar.gz"
)

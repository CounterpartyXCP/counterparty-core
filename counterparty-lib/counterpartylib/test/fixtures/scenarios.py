...
UNITTEST_FIXTURE = [
    ...
    [
        "issuance",
        (ADDR[0], None, "LOCKED", 0, True, None, None, "LOCK"),
        {"encoding": "multisig"},
    ],
    [
        "order",
    ...
    [
        "send",
        (ADDR[0], ADDR[1], "DIVISIBLE", DP["quantity"]),
        {"encoding": "multisig"},
        None,
    ],
    ...
    [
        "send",
        (ADDR[0], MULTISIGADDR[0], "XCP", DP["quantity"] * 3),
        {"encoding": "multisig"},
        None,
    ],
    [
    ...
    [
        "send",
        (ADDR[0], MULTISIGADDR[0], "NODIVISIBLE", 10),
        {"encoding": "multisig"},
        None,
    ],
    [
    ...
    [
        "bet",
        (ADDR[0], ADDR[0], 1, 1388000001, 9, 9, 0.0, 5040, 100),
        {"encoding": "multisig"},
    ],
    [
        "bet",
        (ADDR[1], ADDR[0], 0, 1388000001, 9, 9, 0.0, 5040, 100),
        {"encoding": "multisig"},
    ],
    ["create_next_block", 100],  # 310100
    [
        "bet",
        (ADDR[1], ADDR[0], 3, 1388000200, 10, 10, 0.0, 5040, 1000),
        {"encoding": "multisig"},
    ],
    [
        "broadcast",
    ...
    [
        "bet",
        (ADDR[4], ADDR[4], 1, 1388000001, 9, 9, 0.0, 5040, 100),
        {"encoding": "multisig"},
    ],
...
PARSEBLOCKS_FIXTURE = UNITTEST_FIXTURE + [
    [
        ...
        501,
        False,
    ]  # parse_block=False so we can unittest blocks.parse_block
]
...
def generate_standard_scenario(address1, address2, order_matches):
    ...
    return [
        ...
        [
            "send",
            (address1, address2, "XCP", DP["small"]),
            {"encoding": "multisig"},
            None,
        ],
        [

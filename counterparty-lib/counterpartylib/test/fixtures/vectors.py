...
UNITTEST_VECTOR = {
    ...
    'gettxinfo': {
        ...
        'get_tx_info_legacy': [
            # data in OP_CHECKSIG script
            {
                'in': (BlockchainParser().deserialize_tx('', use_txid=True), DP['default_block_index']),
                'out': ('mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns',
                        'mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc',
                        5430,
                        10000,
        ...
        'get_tx_info_new': [
            ...
            {
                'in': (
                    BlockchainParser().deserialize_tx('', use_txid=True),
                    DP['default_block_index'],
                    None,
                    True),
                'out': ('mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns',
    ...
    'ledger': {
        ...
        'last_message': [{
            'in': (),
            'out': {'message_index': 1237,
                    'block_index': 310500,
                    'command': 'parse',
                    'category': 'blocks',
                    'bindings': '{"block_index":310500,"ledger_hash":"5ffefc7a2724be6bd697796bb82638ec913c5cbb73627153d1a13b48c7a6c02d","messages_hash":"1105c545d6787d09afe501ca07bb837666117dacb45854e96d5ca90d6b6a13a5","txlist_hash":"35f4a33840d002ab4e0e44f11c1749ae95b41376927fb346140508b32518edd1"}',
                    'timestamp': 0,
                    'event': 'BLOCK_PARSED'}
        }],
        'get_asset_id': [{

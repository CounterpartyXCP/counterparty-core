...
UNITTEST_VECTOR = {
    ...
    "gettxinfo": {
        "get_tx_info": [
            ...
            {
                "in": (
                    BlockchainParser().deserialize_tx(
    ...
    "burn": {
        ...
        "compose": [
            ...
            },
            {
                ...
                "out": (
                    P2SH_ADDR[0],
                    [("mvCounterpartyXXXXXXXXXXXXXXW24Hef", 31000000)],
                    None,
                ),
            },
        ],
        ...
        "validate": [
            ...
            },
            {
                ...
                "error": (
                    ...
                    "integer overflow, quantity too large",
                ),
            },
            {
        ...
        "compose": [
            ...
            },
            {
                ...
                "error": (
                    ...
                    "quantity must be an int (in satoshi)",
                ),
            },
            {
        ...
        "validate": [
            ...
            },
            {
                ...
                "out": (
                    ...
                    None,
                    [
                        "cannot pay dividends to holders of BTC",
    ...
    "order": {
        "validate": [
            ...
            },
            {
                ...
                "out": (
                    [
                        "no such asset to give (NOASSETA)",
                        "no such asset to get (NOASSETB)",
                    ]
                ),
            },
            {
    ...
    "dispenser": {
        "validate": [
            ...
            },
            {
                ...
                "out": (
                    None,
                    ["address doesnt has an open dispenser for asset PARENT"],
                ),
            },
            {
                "in": (
        ...
        "construct": [
            {
                ...
                "error": (
                    ...
                    "Exact fees must be in satoshis.",
                ),
            },
            {
                "in": (
                ...
                "error": (
                    exceptions.TransactionError,
                    "Fee provided must be in satoshis.",
                ),
            },
            {
                "in": (
        ...
        "scriptpubkey_to_address": [
            ...
            },
            {
                ...
                "in": (
                    bitcoinlib.core.CScript(
                        bitcoinlib.core.x(
                            "a9144264cfd7eb65f8cbbdba98bd9815d5461fad8d7e87"
                        )
                    ),
                ),
        ...
        "make_pubkeyhash": [
            {
                "comment": "mono‐sig",
                "in": (
                    "02513522cbf07b0bd553b0d8f8414c476c9275334fd3edfa368386412e3a193558",
                ),
    ...
    "ledger": {
        "generate_asset_id": [
            ...
            {"in": (f"A{2 ** 64 - 1}", 308000), "out": 2**64 - 1},
            {
                ...
                "error": (
                    exceptions.AssetNameError,
                    "long asset names must be numeric",
                ),
            },
            {
                "in": ("BCDE_F", 308000),
        ...
        "value_in": [
            ...
            },
            {
                ...
                "error": (
                    QuantityError,
                    "Fractional quantities of indivisible assets.",
                ),
            },
        ],
        "value_out": [
    ...
    "util": {
        "api": [
            ...
            },
            {
                ...
                "in": (
                    "unpack",
                    {"data_hex": "0000000000000000000000010000000002faf080"},
                ),
        ...
        "parse_subasset_from_asset_name": [
            ...
            },
            {
                ...
                "error": (
                    exceptions.AssetNameError,
                    "parent asset name starts with ‘A’",
                ),
            },
            {
                "in": ("BTC.child1",),
    ...
    "address": {
        "pack": [
            ...
            {
                "config_context": {
                    "P2SH_ADDRESSVERSION": config.P2SH_ADDRESSVERSION_MAINNET
                },
            ...
            {
                "config_context": {
                    "P2SH_ADDRESSVERSION": config.P2SH_ADDRESSVERSION_TESTNET
                },
        ...
        "unpack": [
            {
                "in": (
                    binascii.unhexlify("006474849fc9ac0f5bd6b49fe144d14db7d32e2445"),
                ),
                "out": "1AAAA1111xxxxxxxxxxxxxxxxxxy43CZ9j",
            },
            {
                "in": (
                    binascii.unhexlify("00647484b055e2101927e50aba74957ba134d501d7"),
                ),
                "out": "1AAAA2222xxxxxxxxxxxxxxxxxxy4pQ3tU",
            },
            {
                "in": (
                    binascii.unhexlify("055ce31be63403fa7b19f2614272547c15c8df86b9"),
                ),
                "out": "3AAAA1111xxxxxxxxxxxxxxxxxxy3SsDsZ",
            },
            {
                "in": (
                    binascii.unhexlify("C40A12AD889AECC8F6213BFD6BD47911CAB1C30E5F"),
                ),
    ...
    "versions.enhanced_send": {
        "unpack": [
            ...
            },
            {
                "in": (
                    binascii.unhexlify(
                        "0000000000000001" + "000000000000007b" + "0001"
                    ),
                    DP["default_block_index"],
                ),
    ...
    "versions.mpma": {
        "unpack": [
            ...
            },
            {
                ...
                "out": (
                    {"XCP": [(ADDR[2], DP["quantity"]), (ADDR[1], DP["quantity"])]}
                ),
            },
            {
                "in": (
        ...
        "validate": [
            ...
            },
            {
                ...
                "out": (
                    [f"quantities must be an int (in satoshis) for XCP to {ADDR[1]}"]
                ),
            },
            {
                "in": (
            ...
            },
            {
                "in": (
                    ADDR[0],
                    [("XCP", ADDR[2], DP["quantity"]), ("XCP", ADDR[1], 0)],
                    1,
                ),
        ...
        "compose": [
            {
                "in": (
                    ADDR[0],
                    [("XCP", ADDR[1], DP["quantity"] * 1000000)],
                    None,
                    None,
                ),

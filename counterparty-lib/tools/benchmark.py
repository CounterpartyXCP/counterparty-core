...
def benchmark_new_balances(old_balance_db):
    ...
    rows_in_old_balances = old_cursor.execute(
    ...
    description = (
        "Get balances for 100 addresses with most assets from `old_balances`..."
    )
    queries = []
    ...
    description = (
        "Get balances for 100 addresses with most assets from `new_balances`..."
    )
    queries = []

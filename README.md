...
* Python 3 packages: SQLite3, requests, appsdirs, prettytable, python-dateutil, json-rpc, werkzeug, pycoin (see [this link](https://github.com/xnova/counterpartyd_build/blob/master/dist/reqs.txt) for exact working versions)
* Bitcoind

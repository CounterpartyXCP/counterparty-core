...
# From what block on does CIP12 activates
BLOCK_START_ADDRESSES_OPTIONS_MAINNET = 0
BLOCK_START_ADDRESSES_OPTIONS_TESTNET = 0
BLOCK_START_ADDRESSES_OPTIONS_REGTEST = 0

BLOCK_START_ADDRESSES_OPTIONS = 0

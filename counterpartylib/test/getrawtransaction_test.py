...
def test_getrawtransaction(server_db):
    ...
    result = util_test.insert_raw_transaction(rawtx, server_db)
    ...
    found_rawtx = util.api(
        method="getrawtransaction",
        params={"tx_hash": result["tx_hash"]}
    )
    assert found_rawtx == rawtx

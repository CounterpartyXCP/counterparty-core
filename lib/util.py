...
def get_dividends (db, validity=None, address=None, asset=None, order_by='tx1_index', order_dir='asc'):
    cursor = db.cursor()
...
def get_burns (db, validity=True, address=None, order_by='tx1_index', order_dir='asc'):
    cursor = db.cursor()

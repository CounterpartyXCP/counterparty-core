...
`check_reorg()` now also reports whether it rolled back, and both loops discard the event they were holding when it did: that event was selected against the branch the rollback has just undone.

...
class MultiSigAddressError(AddressError): pass
class Base58Error(Exception): pass
class InvalidBase58Error(Base58Error): pass
class Base58ChecksumError(InvalidBase58Error): pass
class VersionByteError(Exception): pass
...
def base58_check_decode(s, version):
    ...
    for c in s:
        ...
        if c not in b58_digits:
            raise InvalidBase58Error('Not a valid Base58 character: ‘{}’'.format(c))

...
UNITTEST_FIXTURE_SQL = "counterpartycore/test/fixtures/scenarios/unittest_fixture.sql"
UNITTEST_VECTORS_PY = "counterpartycore/test/fixtures/vectors.py"
...
with open(UNITTEST_VECTORS_PY, "r") as f:
    ...
    for tx_index, old_txid in sorted(old_txid_map.items(), key=lambda kv: kv[0]):
        ...
        filedata = filedata.replace(
            to_literal_byte_string(old_txid), to_literal_byte_string(new_txid)
        )

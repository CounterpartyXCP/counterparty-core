...
def test_is_valid_address():
    ...
    assert address.is_valid_address("tb1q5ljtmkhtkhgrxdxaqvvut2trtrrsjgx8fsxfl5", "testnet")
    assert address.is_valid_address("tb1qv9g0n4qltu9hss0khegwmg94lxn6sy6haqhj7a", "testnet")
    assert address.is_valid_address("mtuTqahviyGpNL3qT5zV88Gm1YAbD2zZg8", "testnet")
    assert not address.is_valid_address("mtuTqahviyGpNL3qT5zV88Gm1YAbD2zZg", "testnet")
    assert not address.is_valid_address("tc1qv9g0n4qltu9hss0khegwmg94lxn6sy6haqhj7a", "testnet")
    ...
    assert not address.is_valid_address("toto", "testnet")
    assert address.is_valid_address("mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc", "testnet")
    assert address.is_valid_address("mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns", "testnet")

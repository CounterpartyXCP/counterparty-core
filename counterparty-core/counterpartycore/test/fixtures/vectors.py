...
from .contract_vectors.apiv1 import API_V1_VECTOR
...
from .contract_vectors.messages.enhancedsend import ENHANCED_SEND_VECTOR
...
from .contract_vectors.messagetype import MESSAGE_TYPE_VECTOR

                ...
                "records": [
                    {
                        ...
                        "values": {
                            ...
                            "command": "insert",
                            "category": "sends",
                            "bindings": '{"block_index":310704,"msg_index":0,"send_type":"attach","status":"invalid: destination vout is an OP_RETURN output","tx_hash":"72a62abedd38d5f667150929c24dc1d7465dd81ab1502974814d20c1f65d871f","tx_index":705}',
                            "event": "ATTACH_TO_UTXO",
                        },
                    },
                ],
                ...
                "records": [
                    {
                        ...
                        "values": {
                            ...
                            "command": "insert",
                            "category": "sends",
                            "bindings": '{"block_index":310704,"msg_index":0,"send_type":"attach","status":"invalid: destination vout is greater than the number of outputs","tx_hash":"72a62abedd38d5f667150929c24dc1d7465dd81ab1502974814d20c1f65d871f","tx_index":705}',
                            "event": "ATTACH_TO_UTXO",
                        },
                    },
                ],
                ...
                "records": [
                    {
                        ...
                        "values": {
                            ...
                            "command": "insert",
                            "category": "sends",
                            "bindings": '{"block_index":310704,"msg_index":0,"send_type":"attach","status":"invalid: no UTXO to attach to","tx_hash":"72a62abedd38d5f667150929c24dc1d7465dd81ab1502974814d20c1f65d871f","tx_index":705}',
                            "event": "ATTACH_TO_UTXO",
                        },
                    },
                ],

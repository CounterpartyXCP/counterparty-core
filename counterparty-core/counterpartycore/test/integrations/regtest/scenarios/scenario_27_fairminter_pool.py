SCENARIO = [
    ...
    },
    {
        ...
        "set_variables": {
            "FAIRMULTI_HASH": "$TX_HASH",
            "FAIRMULTI_TX_INDEX": "$TX_INDEX",
            "FAIRMULTI_DEADLINE_BLOCK_INDEX": "$BLOCK_INDEX + 2",
        },
    },
    {
        ...
        "controls": [
            {
                ...
                "result": {
                    "asset_a": "FAIRMULTI",
                    "asset_b": "XCP",
                    "block_index": "$FAIRMULTI_DEADLINE_BLOCK_INDEX",
                    "lp_asset": "A95428956661682177",
                    "reserve_a": 400000000,
                    "reserve_b": 600000000,
                    "source": "$ADDRESS_1",
                    "tx_hash": "$FAIRMULTI_HASH",
                    "tx_index": "$FAIRMULTI_TX_INDEX",
                },
            },
            {
                "url": "addresses/mvCounterpartyXXXXXXXXXXXXXXW24Hef/balances/A95428956661682177",
                "result": [
                    {

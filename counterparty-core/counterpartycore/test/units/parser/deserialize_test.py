...
def test_deserialize():
    ...
    # Once correct_transaction_fee activates, every output contributes to the miner-fee calculation even when
    # Counterparty parsing has already stopped at the first ordinary output after the data. Historically the final
    # 5,324,538-sat change output was omitted here.
    corrected = deserialize.deserialize_tx(hex, parse_vouts=True, block_index=1_000_000_000)

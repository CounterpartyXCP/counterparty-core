...
def test_compose_long_description(ledger_db, defaults):
    result = (
        defaults["addresses"][1],
        [],
        b"Z\x92\x1b\x00\x00\x18\xc0\xfd\xcd\xeb_\x00\x00\x01\n\x00\x19\x03\xe8\x18d\x1a\x00\x0c5\x00\x1a\x00\r\xbb\xa0\x182\x1a\x00\x0c\xf8P\x1a\x00\x98\x96\x80\xf4\xf4\xf5\xf5x\x1eaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
    )
    assert (
        fairminter.compose(
            ledger_db,
...
def test_unpack():
    assert fairminter.unpack(
        b"\x92\x1b\x00\x00\x18\xc0\xfd\xcd\xeb_\x00\x00\x01\n\x00\x19\x03\xe8\x18d\x1a\x00\x0c5\x00\x1a\x00\r\xbb\xa0\x182\x1a\x00\x0c\xf8P\x1a\x00\x98\x96\x80\xf4\xf4\xf5\xf5sune asset super top",
        True,
    ) == {
        "asset": "FAIRMINTED",
        "asset_parent": "",
...
def test_parse_fairminter_start_block(
    ...
    message = b"\x92\x1b\x00\x00\x18\xc0\xfd\xcd\xeb_\x00\x00\x01\n\x00\x19\x03\xe8\x18d\x1a\x00\x0c5\x00\x1a\x00\r\xbb\xa0\x182\x1a\x00\x0c\xf8P\x1a\x00\x98\x96\x80\xf4\xf4\xf5\xf5sune asset super top"

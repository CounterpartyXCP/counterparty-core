                ...
                "result": [
                    {
                        ...
                        "params": {
                            ...
                            "block_index": "$BLOCK_INDEX",
                            "destination": "$TX_HASH:0",
                            "destination_address": "$ADDRESS_4",
                            "msg_index": 0,
                            "quantity": 1000000000,
                            "source": "$UTXO_ATTACH_1_TX_HASH:0",
                            "source_address": "$ADDRESS_1",
                            "status": "valid",
                            "tx_hash": "$TX_HASH",
                            "tx_index": "$TX_INDEX",
                            "send_type": "move",
                ...
                "result": [
                    ...
                    },
                    {
                        ...
                        "params": {
                            ...
                            "tx_hash": "$TX_HASH",
                            "tx_index": "$TX_INDEX",
                            "utxos_info": "$UTXO_ATTACH_3_TX_HASH:0,$UTXO_ATTACH_2_TX_HASH:0 $TX_HASH:0 2 ",
                            "transaction_type": "utxomove",
                        },
                        "tx_hash": "$TX_HASH",
                    },

SCENARIO = [
    ...
    },
    {
        ...
        "source": "$UTXO_ATTACH_1_TX_HASH:1",
        "params": {
                ...
                "result": [
                    ...
                    },
                    {
                        ...
                        "params": {
                            ...
                            "tx_hash": "$TX_HASH",
                            "tx_index": "$TX_INDEX",
                            "utxos_info": "$UTXO_ATTACH_1_TX_HASH:1 $TX_HASH:0 1 ",
    ...
    },
    {
        ...
        "transaction": "movetoutxo",
        "source": "$UTXO_ATTACH_3_TX_HASH:1",
        "params": {
            "destination": "$ADDRESS_6",
            "inputs_set": "$UTXO_ATTACH_2_TX_HASH:1,$UTXO_ATTACH_2_TX_HASH:2",
                ...
                "result": [
                    ...
                    },
                    {
                        ...
                        "params": {
                            ...
                            "tx_hash": "$TX_HASH",
                            "tx_index": "$TX_INDEX",
                            "utxos_info": "$UTXO_ATTACH_3_TX_HASH:1,$UTXO_ATTACH_2_TX_HASH:1 $TX_HASH:0 1 ",
                            "transaction_type": "utxomove",
                        },
                        "tx_hash": "$TX_HASH",
                    },

SCENARIO = [
    ...
    {
        "title": "Create fairminter STARTNOW",
        "transaction": "fairminter",
        "source": "$ADDRESS_10",
        "params": {
            "asset": "STARTNOW",
            ...
            "soft_cap": 100,
            "soft_cap_deadline_block": "$CURRENT_BLOCK",
        },
        "expected_error": ["Soft cap deadline block must be > start block."],
    },
    {
        "title": "Create fairminter STARTNOW",
        "transaction": "fairminter",
        ...
        "params": {
            ...
            "description": "let's start now",
            "soft_cap": 100,
            "soft_cap_deadline_block": "$CURRENT_BLOCK + 1",
        },
        "controls": [
            {
                "url": "blocks/$BLOCK_INDEX/events?event_name=NEW_FAIRMINTER,ASSET_ISSUANCE,CREDIT,DEBIT",
                "result": [
                    {
                        "event": "NEW_FAIRMINTER",
                        "event_index": "$EVENT_INDEX_3",
    ...
    },
    {
        ...
        "params": {
            ...
            "description": "let's start now",
            "soft_cap": 100,
            "soft_cap_deadline_block": "$CURRENT_BLOCK + 2",
        },
        "set_variables": {
            "FAIRMINTER_STARTNOW_HASH": "$TX_HASH",
            "FAIRMINTER_STARTNOW_TX_INDEX": "$TX_INDEX",
        },
        "controls": [
            {
                "url": "blocks/$BLOCK_INDEX/events?event_name=NEW_FAIRMINTER,ASSET_CREATION,ASSET_ISSUANCE,DEBIT",
                "result": [
                    ...
                    },
                    {
                        ...
                        "params": {
                            ...
                            "quantity_by_price": 1,
                            "soft_cap": 100,
                            "soft_cap_deadline_block": "$BLOCK_INDEX + 1",
                            "source": "$ADDRESS_10",
                            "start_block": 0,
                            "status": "open",
                            "tx_hash": "$TX_HASH",
                ...
                "result": [
                    {
                        ...
                        "params": {
                            ...
                            "status": "valid",
                            "transfer": False,
                            "tx_hash": "$FAIRMINTER_STARTNOW_HASH",
                            "tx_index": "$FAIRMINTER_STARTNOW_TX_INDEX",
                        },
                        "tx_hash": None,
                    },
                    {
    ...
    {
        "title": "Create fairminter PREMINT",
        "transaction": "fairminter",
        "source": "$ADDRESS_10",
        "params": {
            "asset": "PREMINT",
        ...
        "set_variables": {
            "FAIRMINTER_PREMINT_HASH": "$TX_HASH",
            "FAIRMINTER_PREMINT_TX_INDEX": "$TX_INDEX",
        },
        "controls": [
            {
                "url": "blocks/$BLOCK_INDEX/events?event_name=NEW_FAIRMINTER,ASSET_CREATION,ASSET_ISSUANCE,CREDIT,DEBIT",
                "result": [
                    {
                        "event": "DEBIT",
                        "event_index": "$EVENT_INDEX_7",
    ...
    },
    {
        ...
        "controls": [
            {
                "url": "blocks/$BLOCK_INDEX/events?event_name=FAIRMINTER_UPDATE,ASSET_ISSUANCE,CREDIT,DEBIT,ASSET_DESTRUCTION",
                "result": [
                    {
                        "event": "ASSET_DESTRUCTION",
                        "event_index": "$EVENT_INDEX_5",
                        "params": {
                            ...
                            "tx_hash": "$FAIRMINTER_PREMINT_HASH",
                            "tx_index": "$FAIRMINTER_PREMINT_TX_INDEX",
                        },
                        "tx_hash": None,
                    },
                    {

...
SCENARIO = [
    ...
    {
        "title": "Match order, then pay with BTCpay, then issue asset, then attach to UTXO, then open sell order for XCP",
        "transaction": "multiple",
        "source": "",
        "params": {
            "json_txs": json.dumps(
                {
                    "transactions": [
                        ...
                        },
                        {
                            ...
                            "params": {
                                "address": "$ADDRESS_2",
                                "order_match_id": "$ORDER_1_HASH_00",
                                "quantity": 110000,
                            },
                        },
                        {
        ...
        "controls": [
            {
                "url": "blocks/143/events?event_name=OPEN_ORDER,DEBIT,CREDIT,ASSET_ISSUANCE,ASSET_CREATION,BTC_PAY,ORDER_MATCH_UPDATE,ORDER_MATCH,ORDER_UPDATE,INCREMENT_TRANSACTION_COUNT,ORDER_FILLED,ATTACH_TO_UTXO",
                "result": [
                    {
                        "event": "OPEN_ORDER",
                        "event_index": 271,
                    ...
                    },
                    {
                        ...
                        "event_index": 268,
                        "params": {"block_index": 143, "count": 3, "transaction_id": 100},
                        "tx_hash": "$TX_HASH",
                    },
                    {
                        "event": "CREDIT",
                    ...
                    },
                    {
                        ...
                        "params": {
                            ...
                            "order_match_id": "$ORDER_1_HASH_$TX_HASH",
                            "source": "$ADDRESS_2",
                            "status": "valid",
                            "tx_hash": "$TX_HASH",
                            "tx_index": 30,
                    ...
                    },
                    {
                        "event": "ORDER_FILLED",
                        "event_index": 260,
                        "params": {"status": "filled", "tx_hash": "$TX_HASH"},
                        "tx_hash": "$TX_HASH",
                    },
                    {

...
def get_bet_by_feed(db, address: str, status: str = "open", cursor: int = None, limit: int = 100):
    """
...
def get_dispensers_by_address(
    db, address: str, status: int = 0, cursor: int = None, limit: int = 100
):
    """
...
def get_dispensers_by_asset(db, asset: str, status: int = 0, cursor: int = None, limit: int = 100):
    """
...
def get_orders_by_asset(db, asset: str, status: str = "open", cursor: int = None, limit: int = 100):
    """
...
def get_orders_by_two_assets(
    db, asset1: str, asset2: str, status: str = "open", cursor: int = None, limit: int = 100
):
    """
...
def get_bet_matches_by_bet(
    db, bet_hash: str, status: str = "pending", cursor: int = None, limit: int = 100
):
    """

...
CREATE VIEW IF NOT EXISTS all_holders AS 
        ...
        SELECT * FROM (
            ...
            tx_hash AS escrow, MAX(rowid) AS rowid, CONCAT('open_bet_', CAST(rowid AS VARCHAR)) AS cursor_id,
        ...
        SELECT * FROM (
            ...
            tx_hash AS escrow, MAX(rowid) AS rowid, CONCAT('open_rps_', CAST(rowid AS VARCHAR)) AS cursor_id,
        ...
        SELECT * FROM (
            ...
            tx_hash AS escrow, MAX(rowid) AS rowid, CONCAT('open_dispenser_', CAST(rowid AS VARCHAR)) AS cursor_id,
